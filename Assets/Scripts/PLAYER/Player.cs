...
namespace onlinetutorial.controllers
{
    public class Player : NetworkBehaviour, IPlayer
    {
        ...
        public PlayerHealthController _PlayerHealthController { get; set; }

        public PlayerPhysicsController _PlayerPhsicsController { get; set; }

        public PlayerAttackController _playerAttackController { get; set; }

        public PlayerColorController _PlayerColorController { get; set; }
        ...
        private void Awake()
        {
            GroundPoint = transform.GetChild(0).transform;
            _PlayerHealthController =
                transform.Find("Colliders/Bodycol").transform.GetComponent<PlayerHealthController>();
            _PlayerPhsicsController =
                transform.Find("Colliders/Bodycol").transform.GetComponent<PlayerPhysicsController>();
            _PlayerColorController =
                transform.Find("visual/player1/body1").transform.GetComponent<PlayerColorController>();
